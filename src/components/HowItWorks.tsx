          ...
          {steps.map((step, index) => (
            <motion.div key={step.num} variants={itemVariants} className="relative flex flex-col items-center text-center">
              ...
              <div className="relative mb-6">
                <div className="w-24 h-24 bg-pink-50 rounded-2xl flex items-center justify-center">
                  {step.icon}
                </div>
                <div className="absolute -top-3 -left-3 w-8 h-8 rounded-full bg-insta-gradient text-white flex items-center justify-center font-bold text-sm shadow-md border-2 border-white">
                  {step.num}
                </div>
              </div>
